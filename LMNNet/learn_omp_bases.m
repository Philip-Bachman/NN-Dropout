function [ A ] = learn_omp_bases( X, basis_count, omp_num, round_count, train_count, Ai )
...
% 
% step_sizes = logspace(-2,1,10);
% best_obj = 1e15;
% best_step = 0;
% for s_num=1:numel(step_sizes),
%     step = step_sizes(s_num);
%     A_new = A - (A_grad .* step);
